...
The model using the past closing prices has a lower loss.

> Which model tracks the actual values better over time?
The past closing price model tracks the actual value better over time.

> Which window size works best for the model?
A window size of 10 appeared to work best.
